...
def imageset_features(ffeats_extractor, device, dataset, frame_size, center_crop):
    ...
    images_list, scores, transform, images_path = dh.get_imageset_info(dataset=dataset,
    ...
    for image in tqdm(images_list):
        ...
        img = load_image(img_path, transform, device)
...
def main():
    ...
    ffeats_extractor, device, dataset, cross_dataset, frame_size,\
                                                        center_crop = init_iqa('efficientnet', 'koniq10k')
    ...
    reg.regression(images_features, scores, c_images_feats, c_scores, 'svr', dataset)               
```
