...
```{python tags=c()}
def get_videoset_features(video_list: str, video_path: str, transform, dataset: str = 'LIVE') -> list:
...
def main(mode):
    ...
    if mode == 'save':
        videos_feats = get_videoset_features(video_list, video_path, transform, dataset)
        # Save the model
