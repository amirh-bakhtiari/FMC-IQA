...
def init_vqa(model_name, vqa_dataset):
    ...
    return model, device, vqa_dataset, frame_size, center_crop, layers, diff_layer, frame_diff
...
def main():
    ...
    '''
    # Initialize vqa
    model, device, vqa_dataset, frame_size, center_crop, layers,\
    ...
    reg.regression(pooled_feats, scores, regression_method='svr', dataset=vqa_dataset)               
```
