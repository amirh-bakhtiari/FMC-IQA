...
def get_videoset_features():
    ...
    video_list, dmos, transform = dh.prepare_videoset(dataset='LIVE', frame_size: int = 254,
    ...
    for seq in video_list:
        ...
        videos_frame_features.append(sfv.get_video_style_features(vid_frames, model, device, transform))
    
    return videos_frame_features
```
